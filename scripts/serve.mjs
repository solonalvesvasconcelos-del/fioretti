...
const server=http.createServer(async(req,res)=>{
  try {
    ...
    if(!/^\/(?:index\.html|login\.html|dashboard\.html|novo-chamado\.html|usuarios\.html|indicadores\.html|motorista\/index\.html|(?:css|js|assets)\/[a-zA-Z0-9_./-]+)$/.test(relative)){res.writeHead(404).end('Não encontrado');return;}
